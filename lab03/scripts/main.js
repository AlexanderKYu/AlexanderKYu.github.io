...
function populateListProductChoices(slct2, slct3) {
    ...
    var optionArray = restrictListProducts(products, s3.value);
...
function selectedItems(){
    ...
    if(parseInt(getTotalPrice(chosenProducts)) != 0){
        ...
        document.getElementById("value").innerHTML = "Total price: $ 0.00";
    }
